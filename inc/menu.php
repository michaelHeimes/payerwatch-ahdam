...
function trailhead_top_nav() {
	wp_nav_menu(array(
		...
		'items_wrap'		=> '<ul id="%1$s" class="%2$s" data-responsive-menu="accordion medium-dropdown" data-submenu-toggle="true" data-hover-delay="10" data-closing-time="10" data-alignment="left">%3$s</ul>',
